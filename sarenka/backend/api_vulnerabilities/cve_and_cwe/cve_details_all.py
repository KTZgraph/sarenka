...
class CVEDetailsAll:
    __feeder_url = "https://raw.githubusercontent.com/pawlaczyk/sarenka_tools/master/cve_all.json"
    __file_name = "cve_all.json"
    __source_nist = "https://nvd.nist.gov/vuln/full-listing"
    __nist_url = "https://nvd.nist.gov/vuln/detail/"
    __mitre_cwe_url = "https://cwe.mitre.org/data/definitions/"
    __file_prefix = "cve_all_details"
    __feed_file_path = "feeds\cve_details\\"
