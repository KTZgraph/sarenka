...
from .views import DNSSearcherView, CVESearchView, CensysHostSearchView, ListVendors, login_required_view, CWETop25, CWEData, CommandsWindows, LocalWindows
...
urlpatterns = [
    ...
    path('search/<str:ip_address>', CensysHostSearchView.as_view(), name="get_censys_host_data"),
