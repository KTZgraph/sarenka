...
results = todos_collection.find(
    {"name": "Imie"}
)  # <pymongo.cursor.Cursor object at 0x0000016757F1CDC0>
# print(list(results))
...
results = todos_collection.find({"date": {"$gt": d}}).sort(
    "name"
...
result = todos_collection.delete_one(
    {"_id": ObjectId("61ffd49d3a88cf84ab6c40c2")}
)  # usuwanie po id
