...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cve',
            name='cwe',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='vulnerabilities.cwe', unique=True),
        ),
        migrations.AddField(
            model_name='cve',
            name='version',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='vulnerabilities.version', unique=True),
        ),
        migrations.CreateModel(
            name='CPEMatch',
            fields=[
