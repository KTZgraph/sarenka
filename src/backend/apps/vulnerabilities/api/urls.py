...
urlpatterns = [
    ...
    path(
        "reference/<int:pk>/", views.ReferenceDetail.as_view(), name="reference-detail"
    ),
    path(
        "cve/<int:pk>/reference-create/",
    ...
    path(
        "vector-list/<str:severity>/",
        views.VectorSeverityList.as_view(),
        name="vector-list-filter-severity",
    ),
