...
export const sidebarItems = [
  ...
  //statistics
  {
    ...
    elements: [
      ...
      {
        id: "sidebar-element-statistics-2",
        activePage: "diagrams",
        label: "diagrams",
        to: "/diagrams",
        icon: <PieChartRoundedIcon className="sidebar__icon" />,
      },
      {
        id: "sidebar-element-statistics-3",
        activePage: "visualizations",
        label: "visualizations",
        to: "/visualizations",
        icon: <AutoGraphRoundedIcon className="sidebar__icon" />,
      },
      {
        id: "sidebar-element-statistics-4",
        activePage: "periodicTable",
